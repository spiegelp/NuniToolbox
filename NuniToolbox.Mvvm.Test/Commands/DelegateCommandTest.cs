...
using NuniToolbox.Mvvm.Commands;

namespace NuniToolbox.Mvvm.Test.Commands;
...
public class DelegateCommandTest
{
    ...
    {
        DelegateCommand<int> command = new(i => { }, i => true);
