...
public class LocalDateTest
{
    ...
    public void Test_WithMonth_Ok()
    {
        ...
        LocalDate localDateResult = new(2019, Month.October, 5);

        Assert.Equal(localDateResult, localDate);

        localDate = new LocalDate(2019, Month.March, 31).WithMonth(Month.April);
        localDateResult = new(2019, Month.April, 30);
        ...
        localDateResult = new(2019, Month.February, 28);
    ...
    public void Test_WithDay_Ok()
    {
        ...
        LocalDate localDateResult = new(2019, Month.November, 4);
    ...
    public void Test_AddYears_Ok()
    {
        LocalDate localDate = new(2019, Month.November, 5);
        int yearsToAdd = 2;
        LocalDate localDateResult = new(2021, Month.November, 5);

        Assert.Equal(localDateResult, localDate.AddYears(yearsToAdd));

        localDate = new(2019, Month.November, 5);
        yearsToAdd = -2;
        localDateResult = new(2017, Month.November, 5);

        Assert.Equal(localDateResult, localDate.AddYears(yearsToAdd));

        localDate = new(2020, Month.February, 29);
        yearsToAdd = 1;
        localDateResult = new(2021, Month.February, 28);
    ...
    public void Test_AddMonths_Ok()
    {
        LocalDate localDate = new(2019, Month.November, 5);
        int monthsToAdd = 1;
        LocalDate localDateResult = new(2019, Month.December, 5);

        Assert.Equal(localDateResult, localDate.AddMonths(monthsToAdd));

        localDate = new(2019, Month.November, 5);
        monthsToAdd = -2;
        localDateResult = new(2019, Month.September, 5);

        Assert.Equal(localDateResult, localDate.AddMonths(monthsToAdd));

        localDate = new(2019, Month.November, 5);
        monthsToAdd = 14;
        localDateResult = new(2021, Month.January, 5);

        Assert.Equal(localDateResult, localDate.AddMonths(monthsToAdd));

        localDate = new(2019, Month.November, 5);
        monthsToAdd = -28;
        localDateResult = new(2017, Month.July, 5);

        Assert.Equal(localDateResult, localDate.AddMonths(monthsToAdd));

        localDate = new(2019, Month.March, 31);
        monthsToAdd = 1;
        localDateResult = new(2019, Month.April, 30);
    ...
    public void Test_AddDays_Ok()
    {
        LocalDate localDate = new(2019, Month.November, 5);
        int daysToAdd = 3;
        LocalDate localDateResult = new(2019, Month.November, 8);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2019, Month.November, 5);
        daysToAdd = 29;
        localDateResult = new(2019, Month.December, 4);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2019, Month.November, 5);
        daysToAdd = 60;
        localDateResult = new(2020, Month.January, 4);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2019, Month.November, 5);
        daysToAdd = -3;
        localDateResult = new(2019, Month.November, 2);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2019, Month.November, 5);
        daysToAdd = -37;
        localDateResult = new(2019, Month.September, 29);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2020, Month.February, 28);
        daysToAdd = 1;
        localDateResult = new(2020, Month.February, 29);
        ...
        localDate = new(2020, Month.February, 28);
        daysToAdd = 2;
        localDateResult = new(2020, Month.March, 1);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2019, Month.February, 28);
        daysToAdd = 1;
        localDateResult = new(2019, Month.March, 1);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2020, Month.March, 1);
        daysToAdd = -1;
        localDateResult = new(2020, Month.February, 29);

        Assert.Equal(localDateResult, localDate.AddDays(daysToAdd));

        localDate = new(2019, Month.March, 1);
        daysToAdd = -1;
        localDateResult = new(2019, Month.February, 28);
    ...
    {
        LocalDate localDate1 = new(2019, Month.November, 5);
        LocalDate localDate2 = new(2019, Month.November, 5);
    ...
    {
        LocalDate localDate1 = new(2019, Month.November, 4);
        LocalDate localDate2 = new(2019, Month.November, 5);
    ...
    {
        LocalDate localDate1 = new(2019, Month.November, 5);
        LocalDate localDate2 = new(2019, Month.October, 5);
