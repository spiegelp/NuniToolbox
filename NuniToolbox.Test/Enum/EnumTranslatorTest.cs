...
public class EnumTranslatorTest
{
    ...
    {
        DictionaryEnumTranslationSource<VehicleType> germanTranslations = new(new CultureInfo("de"));
        ...
        DictionaryEnumTranslationSource<VehicleType> englishTranslations = new(new CultureInfo("en"));
        ...
        EnumTranslator enumTranslator = new();
