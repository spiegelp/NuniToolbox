...
public class BoolAndToVisibilityConverterTest
{
    public BoolAndToVisibilityConverterTest() { }
    ...
    [InlineData(Visibility.Collapsed, Visibility.Visible, new object[] { true, false }, Visibility.Collapsed)]
    [InlineData(Visibility.Collapsed, Visibility.Visible, new object[] { true, true, false }, Visibility.Collapsed)]
    ...
    [InlineData(Visibility.Visible, Visibility.Collapsed, new object[] { true, false }, Visibility.Visible)]
    [InlineData(Visibility.Visible, Visibility.Collapsed, new object[] { true, true, false }, Visibility.Visible)]
    ...
    {
        BoolAndToVisibilityConverter converter = new(falseValue, trueValue);
