...
public class EmptyCollectionToVisibilityConverterTest
{
    public EmptyCollectionToVisibilityConverterTest() { }
    ...
    {
        EmptyCollectionToVisibilityConverter converter = new(emptyValue, notEmptyValue);
